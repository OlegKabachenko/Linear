        ...
        try:
            ...
            Clock.schedule_once(
                lambda dt: self.dispatch(
                    "on_error",
                    "Перевищено максимальну кількість ітерацій, спробуйте змінити параметри!"
                )
            )
            ...
            Clock.schedule_once(
                lambda dt: self.dispatch(
                    "on_error",
                    "Не вдалося виконати передобробку, спробуйте іншу, або змініть її налаштування!"
                )
            )
            ...
            Clock.schedule_once(
                lambda dt: self.dispatch(
                    "on_error",
                    "Спектральний радіус більше за 1, спробуйте змінити налаштування передобробки!"
                )
            )
